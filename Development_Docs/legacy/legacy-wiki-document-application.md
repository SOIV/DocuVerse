...
1. **코드 편집 기능**
   ...
   * 코드 블록에서 단일 클릭으로 전체 개발 환경으로 확장 가능
   * 코드와 문서 간의 양방향 이동 기능
     * 함수 호출/정의 내비게이션 (F12 스타일)
     * 코드 주석과 문서 간의 양방향 링크 유지

2. **VSCode/Cursor 통합 개발 환경**
